...
I am currently a postdoc (Shuimu Scholar 水木学者) in the [THUNLP Group](http://nlp.csai.tsinghua.edu.cn) at Tsinghua University, Beijing, China. My ongoing research projects include LLM-based multi-agent systems, game-theoretic reinforcement learning, and Legal AI. I see myself as a computational linguist with a research interest in enabling AI to think and argue like humans do.
